...
from bot import bot, dispatcher, updater, botStartTime, DOWNLOAD_DIR , IGNORE_PENDING_REQUESTS, LOGGER, Interval, INCOMPLETE_TASK_NOTIFIER, DB_URI, app, main_loop
